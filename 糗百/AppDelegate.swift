...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func changeToMainPage () {
        ...
        tabbarController?.addChildVc(arrVC: [HomeViewController(),FriendsViewController(),LiveViewController()])
        
        tabbarController?.BaseTabBarItem(titles: ["糗事","糗友圈","直播"], Font: Font(fontSize: 12), titleColor:BLACK_COLOR, selectedTitleColor:mainColor, images:["icon_main","main_tab_qbfriends","main_tab_live","icon_chat","icon_me"], selectedImages: ["icon_main_active","main_tab_qbfriends_active","main_tab_live_active"], barBackgroundImage: backgroundImage)
